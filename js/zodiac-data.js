export const ZODIACS = [
  ...
  { name: '龙🐲', branch: '辰', desc: '气宇轩昂，充满智慧，有着远大的理想和抱负。' },
  { name: '蛇🐍', branch: '巳', desc: '神秘睿智，外表冷峻内心热情，有着极强的直觉力。' },
  { name: '马🐴', branch: '午', desc: '热情奔放，向往自由，有着不折不挠的进取精神。' },
  { name: '羊🐑', branch: '未', desc: '温文尔雅，富有同情心，具有浓厚的人情味和艺术气质。' },
  { name: '猴🐵', branch: '申', desc: '聪明伶俐，幽默风趣，多才多艺且有着极强的好奇心。' },
  { name: '鸡🐔', branch: '酉', desc: '勤奋守信，神采奕奕，做事果断且有着出色的表达能力。' },
